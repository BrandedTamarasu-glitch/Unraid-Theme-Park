...
3. Include Community Applications and Unassigned Devices in every readability pass.
4. Add targeted overrides only when a theme accent or button state fails contrast.
5. Keep Plex deferred until resource references are vendored and rewritten to local plugin paths.
